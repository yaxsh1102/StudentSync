...
import { Calendar, MapPin, Clock, Users, AlertCircle, Share2 } from 'lucide-react';
import Navbar from '../components/Navbar';

const event = {
  id: 1,
  title: "Indigenous Hackathon By DAIICT",
  image: "https://th.bing.com/th/id/OIP._D1d2TEmPIdlP6Y7HuT7qwHaEX?rs=1&pid=ImgDetMain",
  type: "Hackathon",
  date: "21/09/2024",
  time: "9:00 AM - 6:00 PM",
  venue: "Dhirubhai Ambani Institute of Information and Communication Technology, Gandhinagar, Gujarat",
  ...
  sponsors: ["TechCorp India", "InnovateNow Foundation", "Gujarat Innovation Society"]
};
      ...
      <div className="max-w-2xl w-full bg-gray-900 rounded-lg shadow-lg ">
        <header className="bg-yellow-500 text-black rounded-t-lg">
          <div className="px-4 py-4 sm:px-6 sm:py-6">
            ...
            <p className="text-yellow-700 mt-1 text-sm sm:text-base">{event.type}</p>
          </div>
        </header>

        <main className="p-4 sm:p-6">
          <img src={event.image} alt={event.title} className="w-full h-40 sm:h-52 object-cover mb-4 rounded-lg" />
          ...
          <h2 className="text-lg sm:text-xl font-bold text-yellow-300 mb-3">About the Event</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <ul className="space-y-1 text-xs sm:text-sm">
                ...
                <li><strong>Sponsors:</strong> {event.sponsors.join(', ')}</li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-yellow-300 mb-2">Prizes</h3>
          ...
          <h2 className="text-lg sm:text-xl font-bold text-yellow-300 mb-3">Rules and Regulations</h2>
